...
<footer class="site-footer">
   <div class="container">
      <div class="row justify-content-between">
         ...
         <div class="col-lg-2 col-md-2 footer-col">
            ...
            <div class="footer-text">
               <div class="menu-footer-container">
                  <ul id="menu-footer" class="menu">
                     <li id="menu-item-571" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-571"><a href="#">Catalog</a></li>
                     <li id="menu-item-851" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-851"><a href="#">Blog</a></li>
                     <li id="menu-item-575" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-575"><a href="#">Forum</a></li>
                     <li id="menu-item-572" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-572"><a href="#">About</a></li>
                     <li id="menu-item-574" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-574"><a href="#">Contact</a></li>
                     <li id="menu-item-576" class="log-in menu-item menu-item-type-custom menu-item-object-custom menu-item-576"><a href="#">Login</a></li>
                  </ul>
               </div>
            </div>
         </div>
         <div class="col-lg-2 col-md-2 footer-col">
            ...
            <div class="footer-text">
               <div class="menu-vendors-menu-container">
                  <ul id="menu-vendors-menu" class="menu">
                     <li id="menu-item-577" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-577"><a href="#">Get Listed</a></li>
                  </ul>
               </div>
            </div>
         </div>
         <div class="col-lg-2 col-md-3 footer-col">
            ...
            <div class="footer-text">
               <div class="menu-catalogs-menu-container">
                  <ul id="menu-catalogs-menu" class="menu">
                     <li id="menu-item-579" class="menu-item menu-item-type-taxonomy menu-item-object-suppliers_category menu-item-579"><a href="#">Plants</a></li>
                     <li id="menu-item-578" class="menu-item menu-item-type-taxonomy menu-item-object-suppliers_category menu-item-578"><a href="#">Flowers</a></li>
                     <li id="menu-item-581" class="menu-item menu-item-type-taxonomy menu-item-object-suppliers_category menu-item-581"><a href="#">Fruits</a></li>
                     <li id="menu-item-580" class="menu-item menu-item-type-taxonomy menu-item-object-suppliers_category menu-item-580"><a href="#">Vegetables</a></li>
                     <li id="menu-item-582" class="menu-item menu-item-type-taxonomy menu-item-object-suppliers_category menu-item-582"><a href="#">Gardening Tools</a></li>
                  </ul>
               </div>
            </div>
         </div>
   ...
   <div class="footer-bot-nav">
    ...
    <div class="footer-copyright">
		<p>© 2019 Demo, LLC. All Rights Reserved. Web Design by <a rel="noopener" target="_blank" href="https://lumina.nyc/">Lumina</a>.</p>
	</div>
</footer>
